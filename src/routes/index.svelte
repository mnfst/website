	...
	<div class="columns">
		<div class="column">
            ...
            <table class="table is-bordered is-striped is-hoverable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Ambitioni dedisse scripsisse iudicaretur. sancimus
                    haerentia.
                  </td>
            ...
            <blockquote cite="https://www.huxley.net/bnw/four.html">
              <p>
                Inmensae subtilitatis, obscuris et malesuada fames. Gallia est
            ...
            <p>
              A communi observantia non est recedendum. Gallia est omnis divisa
              in partes tres, quarum. Quam diu etiam furor iste tuus nos eludet?
              Integer legentibus erat a ante historiarum dapibus. Fabio vel
              iudice vincam, sunt in culpa qui officia. in partes tres, quarum.
            </p>
            <p>
              A communi observantia non est recedendum. Gallia est omnis divisa
              in partes tres, quarum. Quam diu etiam furor iste tuus nos eludet?
            ...
            />
            <p>
              Quisque ut dolor gravida, placerat libero vel, euismod. Nihil hic
            ...
            <p>
              Excepteur sint obcaecat cupiditat non proident culpa. Vivamus
              sagittis lacus vel augue laoreet rutrum faucibus. Ullamco laboris
              nisi ut aliquid ex ea commodi consequat. Integer legentibus erat a
              ante historiarum dapibus. Plura mihi bona sunt, inclinet, amari
              petere vellent.
            </p>
            ...
            <h1 class="u-color-green">
              contenu standard avec des balises comprenant des classes
            </h1>
            ...
            <p>
              ...
              product pages for web shops, or user profiles in social networks,
              all of them potentially with different sizes, formats, rules for
              differing elements things can break, designs agreed upon can have
              unintended consequences and look much different than expected.
            </p>

            <p>
              This is quite a problem to solve, but just doing without greeking
              text won't fix it. Using test items of real content and data in
              designs will help, but there's no guarantee that every oddity will
              be found and corrected. Do you want to be sure? Then a prototype
              or beta site with real content published from the real CMS is
            ...
            <p>
              ...
              coming from the CMS (unlike static content elements that will
              always stay the same.) Blocks of Lorem Ipsum with a character
              count range provide a obvious reminder to check and re-check that
              the design and the content model match up.
            </p>

            <p>
              Kyle Fiedler from the Design Informer feels that distracting copy
              is your fault:
            </p>

            <p>
              If the copy becomes distracting in the design then you are doing
              something wrong or they are discussing copy changes. It might be a
              bit annoying but you could tell them that that discussion would be
              best suited for another time. At worst the discussion is at least
            ...
            <p>
              ...
              to read. Lorem Ipsum is needed because words matter, a lot. Just
              fill up a page with draft copy about the client’s business and
              they will actually read it and comment on it. They will be drawn
              to it, fiercely. Do it the wrong way and draft copy can derail
              your design review.
            </p>
            <h3 class="u-font-700">
            ...
            <p>
              ...
              doesn’t make sense in the first place, that will limit any initial
              interest soon enough. Try telling a client to ignore draft copy
              however, and you're up to something you can't win. Whenever draft
            ...
            <p>
              Lorem Ipsum is a tool that can be useful, used intentionally it
              may help solve some problems. If you go about content strategy the
            ...
            <p>
              Cras mattis iudicium purus sit amet fermentum. Quisque ut dolor
              gravida, placerat libero vel, euismod. Ab illo tempore, ab est sed
              immemorabili. Phasellus laoreet lorem vel dolor tempus vehicula.
            </p>
            <p>
              Paullum deliquit, ponderibus modulisque suis ratio utitur. A
              communi observantia non est recedendum. Tityre, tu patulae
              recubans sub tegmine fagi dolor.
            </p>
            <p>
              Ut enim ad minim veniam, quis nostrud exercitation. Fabio vel
              iudice vincam, sunt in culpa qui officia. Ambitioni dedisse
              scripsisse iudicaretur. Vivamus sagittis lacus vel augue laoreet
              rutrum faucibus. Curabitur est gravida et libero vitae dictum.
            </p>
            <p>
              Morbi odio eros, volutpat ut pharetra vitae, lobortis sed nibh. Hi
              omnes lingua, institutis, legibus inter se differunt. Lorem ipsum
              dolor sit amet, consectetur adipisici elit, sed eiusmod tempor
              incidunt ut labore et dolore magna aliqua. Quo usque tandem
              abutere, Catilina, patientia nostra?
            </p>
            <p>
              Quisque placerat facilisis egestas cillum dolore. Cum ceteris in
              veneratione tui montes, nascetur mus. Qui ipsorum lingua Celtae,
              nostra Galli appellantur. Praeterea iter est quasdam res quas ex
              communi.
            </p>
